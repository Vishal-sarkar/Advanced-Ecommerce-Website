                    ...
                    <div class="col">
                        <form method="post" action="{{route('admin.user.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Admin Password Field <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <img src="{{url('upload/no_image.jpg')}}" style="width:100px;height:100px;"
                                                id="showImage">
                                        </div>
                                    </div>
                                    <hr>
                            ...
                            <div class="text-xs-right">
                                <input type="submit" value="Add User" class="btn btn-rounded btn-primary mb-5">
                            </div>
                        </form>
