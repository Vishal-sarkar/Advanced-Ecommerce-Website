                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                        <a href="{{route('product.view.details',$item->id)}}" class="btn btn-primary"
                                                title="View Product Data"><i class="fa fa-eye"></i></a>
                                            ...
                                            <a href="{{route('product.delete',$item->id)}}" class="btn btn-danger"
                                                id="delete" title="Delete Data"><i class="fa fa-trash"></i></a>
                                                    ...
                                                    <a href="{{route('product.inactive',$item->id)}}" class="btn btn-danger"
                                                        title="Inactive NowEdit Data"><i class="fa fa-arrow-down"></i></a>
                                                    @else
