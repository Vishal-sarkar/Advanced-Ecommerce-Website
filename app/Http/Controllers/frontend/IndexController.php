...
class IndexController extends Controller
{
    public function index(){
        ...
        return view('frontend.index', compact('categories','sliders','products','featured','hot_deals','special_offers','skip_product_0','skip_category_0','skip_category_1','skip_product_1','skip_brand_1','skip_brand_product_1','blogpost'));
    }
    ...
    public function ProductDetails($id,$slug){
        ...
        $product_size_hin = explode(',',$color_hin);

        $multiImag = Multiimg::where('product_id' ,$id)->get();
        $hot_deals = Product::where('hot_deals',1)->where('discount_price','!=',NULL)->orderBy('id','DESC')->get();
        $cat_id = $product->category_id;
        $relatedProduct = Product::where('category_id' ,$cat_id)->where('id','!=',$id)->orderBy('id','DESC')->get();
        return view('frontend.product.product_details', compact('product','multiImag','color_en','product_color_en','product_color_hin','product_size_en','product_size_hin','relatedProduct','hot_deals'));
    }
